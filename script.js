...
function resetAttribute (tabnum){
  ...
  if (tabnum.localeCompare("1") == 0) {
    map.attributionControl
    .setPrefix('Reference:' + '<br />' + 'Capital Workforce Partners 2015-16 Program Year' + '<br />' + 'View <a href="http://github.com/ngocdo67/leaflet-map-panes">code on GitHub</a>, created with' + '<br />' +  '<a href="http://leafletjs.com" title="A JS library for interactive maps">Leaflet</a>');
...
$.getJSON("All updated 10-2016.geojson", function (data) {   
